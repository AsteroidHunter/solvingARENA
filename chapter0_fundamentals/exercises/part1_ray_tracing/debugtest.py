...
def raytrace_triangle_with_bug(
    ...
    '''
    # DEBUGGER HIGHLIGHTED THE LINE BELOW; .size[0] -> shape[0] or size(0)
    NR = rays.shape[0]

    A, B, C = einops.repeat(triangle, "pts dims -> pts NR dims", NR=NR)

    # DEBUGGER HIGHLIGHTED THE LINE BELOW; the dimension was missing
    O, D = rays.unbind(dim=1)

    mat = t.stack([- D, B - A, C - A], dim=-1)

    # DEBUGGER HIGHLIGHTED THE LINE BELOW; the error was in the stacking function
    # adding dim=-1 fixed the error
